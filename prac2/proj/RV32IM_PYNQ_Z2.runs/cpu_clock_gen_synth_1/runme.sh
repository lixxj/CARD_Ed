...
HD_PWD='/afs/inf.ed.ac.uk/user/s20/s2003300/Desktop/Coursework/CARD/prac2/proj/RV32IM_PYNQ_Z2.runs/cpu_clock_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_clock_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_clock_gen.tcl
